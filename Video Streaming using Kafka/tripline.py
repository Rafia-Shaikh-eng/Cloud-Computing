...
class Tripline:
    ...
    count = 0
    _line = None
    #static variable for collision (was None)
    _collisions = {}
    _direction_1 = None
    _direction_2 = None
    _buffer_1 = None
    ...
    def draw(self, frame):
        ...
        if not self._is_buffer:
            ...
            msg = 'Count: %d' % Tripline.count    #self.count
    ...
    def add_collision(self, person):
        ...
        # if first hit
        if key not in self._collisions:     #was (self._collisions)

            Tripline.count += 1
            #self.count += 1
            Tripline._collisions[key] = 10
    ...
    def remove_collision(self, person):
        key = person.name
        if key in Tripline._collisions:         #was (self._collisions)
            Tripline._collisions[key] -= 1      #was (self._collisions)
            if Tripline._collisions[key] == 0:  #was (self._collisions)
                del Tripline._collisions[key]   #was (self._collisions)
